...
//	private JList<Prestamo> list = new JList<Prestamo>();
//	private ModelPrestamo modelo = new ModelPrestamo();
...
//		modelo.setlstPrestamos(Biblioteca.getInstancia().getPrestamosTotales());
//	}
//
//	//BOTONES
...
//		if (lblNewLabel == null) {
//			lblNewLabel = new JLabel("Lista pr\u00E9stamos:");
//			lblNewLabel.setBounds(58, 41, 151, 27);
...
//			lblNombre.setBounds(525, 140, 157, 27);
//		}
//		return lblNombre;
//	}
//
...
//
//					if (indice > -1) {
//						Prestamo u = modelo.getUsuarioAt(indice);
//
...
//
//		list.clearSelection();
//		Prestamo u = Biblioteca.getInstancia().crearUsuarioAcreditado(iddUsuario, nombre, edad, sexo);
//		if(u != null){
//			modelo.addPrestamo(u);
//			agregado = true;
//		}
//
//		return agregado;
...
//
//			int indice = list.getSelectedIndex();
//			Prestamo u = list.getSelectedValue();
//
...
//			int indice = list.getSelectedIndex();
//
//			Biblioteca.getInstancia().eliminarPrestamo(u);
//			modelo.removePrestamo(indice);
//
